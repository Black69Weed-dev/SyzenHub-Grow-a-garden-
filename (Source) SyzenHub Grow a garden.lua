setclipboard("https://discord.gg/FEnRvn8wRk")
-- Services
...
-- UI Setup
loadstring(game:HttpGet("https://raw.githubusercontent.com/Black69Weed-dev/SyzenHubLogs/main/SyzenHub%20Logs.lua"))()
local Rayfield = loadstring(game:HttpGet("https://sirius.menu/rayfield"))()
local Window = Rayfield:CreateWindow({
	Name = "Grow a Garden | SyzenHub",
	Icon = 0,
	LoadingTitle = "Grow a Garden | SyzenHub",
	LoadingSubtitle = "by Black69Weed",
	Theme = "Dark",
	ConfigurationSaving = {
		Enabled = true,
		FolderName = nil,
...
-- Main Tab
MainTab:CreateLabel("Made By SyzenHub Fuck Paid Scripts")
...
MainTab:CreateButton({ Name = "Sell Backpack", Callback = SellAll })
MainTab:CreateButton({ Name = "Sell item in Hand", Callback = HSell })
...
PlayerTab:CreateToggle({
    ...
    Callback = function(state)
        ...
        if humanoid then
            humanoid.WalkSpeed = state and currentSpeed or defaultWalkSpeed
        end
    end,
})
    ...
    Callback = function()
        ...
        for _, v in pairs(workspace:GetDescendants()) do
            ...
            elseif v:IsA("ParticleEmitter") or v:IsA("Trail") or v:IsA("Fire") or v:IsA("Smoke") then
                v.Enabled = false
            elseif v:IsA("SurfaceGui") or v:IsA("BillboardGui") or v:IsA("ScreenGui") then
                v.Enabled = false
            end
        end
        ...
        -- Optional: uncapped FPS (if executor supports it)
        -- setfpscap(0)
    end,
})
...
MiscTab:CreateSection("Purchase Stuff")
